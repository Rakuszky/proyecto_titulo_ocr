...
public class Configurator {
    ...
    private String comment = new String("THIS IS CONFIGURATION FILE FOR A.N.P.R. SYSTEM");
    ...
    public Configurator() {
        ...
        // PLATEGRAPH HORIZONTAL GRAPH
        this.setDoubleProperty("platehorizontalgraph_peakfootconstant", 0.05);
        this.setIntProperty("platehorizontalgraph_detectionType",1); // 1=edge detection 0=magnitude derivate
        ...
        this.setIntProperty("neural_maxk", 8000); // maximum K
        this.setDoubleProperty("neural_eps", 0.07); // epsilon 
        this.setDoubleProperty("neural_lambda", 0.05); // lambda factor 
        this.setDoubleProperty("neural_micro", 0.5); // micro 
